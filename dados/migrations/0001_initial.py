    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='socios', to='dados.Empresa')),
                ('empresa_origem', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='participacao_em_sociedades', to='dados.Empresa')),
            ],
        ),
    ]
